...
def extract_comprehensive_008e301f():
    ...
    print("📊 Target: All 126 fields in match_player table")
    ...
    for player in players_data:
        try:
            ...
            summary_fields = [
                ...
                "summary_pass_cmp",
                "summary_pass_att",
                "summary_pass_cmp_pct",
                "summary_pass_prgp",
                "summary_carry_carries",
                "summary_carry_prgc",
                "summary_take_att",
                "summary_take_succ",
            ]
            ...
            passing_fields = [
                "passing_total_cmp",
                "passing_total_att",
                "passing_total_cmp_pct",
                "passing_total_totdist",
                "passing_total_prgdist",
                "passing_short_cmp",
                "passing_short_att",
                "passing_short_cmp_pct",
                "passing_medium_cmp",
                "passing_medium_att",
                "passing_medium_cmp_pct",
                "passing_long_cmp",
                "passing_long_att",
                "passing_long_cmp_pct",
                "passing_ast",
                "passing_xag",
                "passing_xa",
                "passing_kp",
            ...
            poss_fields = [
                "poss_touches",
                "poss_touches_def_pen",
                "poss_touches_def_3rd",
                "poss_touches_mid_3rd",
                "poss_touches_att_3rd",
                "poss_touches_att_pen",
                "poss_touches_live",
                "poss_take_att",
                "poss_take_succ",
                "poss_take_succ_pct",
