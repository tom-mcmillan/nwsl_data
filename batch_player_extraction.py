...
class BatchPlayerExtraction:
    ...
    def get_html_files(self) -> List[str]:
        ...
        html_files = [f for f in os.listdir(self.html_dir) 
                     if f.endswith('.html') and f.startswith('match_')]
    ...
    def process_all_files(self, skip_existing: bool = True) -> Dict[str, any]:
        ...
        logger.info(f"🚀 Starting batch player extraction")
    ...
    def _get_summary(self) -> Dict[str, any]:
        ...
        return {
            ...
            'success_rate': self.processed_files/(self.processed_files+self.failed_files)*100 if (self.processed_files+self.failed_files) > 0 else 0,
