...
class HTMLPlayerStatsExtractor:
    ...
    def extract_player_stats_from_html(self, html_content: str, match_id: str) -> dict[str, list[dict]] | None:
        """
        ...
        try:
            ...
            return {"home_team": home_stats or [], "away_team": away_stats or []}

        except Exception as e:
            logger.error(f"❌ Error extracting player stats from match {match_id}: {str(e)}")
            return None

    def _extract_team_player_stats(self, soup: BeautifulSoup, team_side: str, match_id: str) -> list[dict] | None:
    ...
    def _extract_player_row_data(self, row, match_id: str) -> dict | None:
    ...
    def _safe_extract_text(self, cell) -> str | None:
    ...
    def _safe_extract_int(self, cell) -> int | None:
    ...
    def _safe_extract_float(self, cell) -> float | None:
    ...
    def _safe_int_conversion(self, value) -> int | None:
    ...
    def _extract_nationality(self, cell) -> str | None:
