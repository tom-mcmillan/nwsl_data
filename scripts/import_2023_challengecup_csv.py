#!/usr/bin/env python3
"""
Import 2023 NWSL Challenge Cup CSV to match_inventory
"""
...
class Import2023ChallengeCupCSV:
    def __init__(self, db_path='data/processed/nwsldata.db'):
        self.db_path = db_path
        
    def import_csv_to_match_inventory(self, csv_path='data/excel_sheets/2023_challengeCup.csv'):
        """Import 2023 Challenge Cup CSV data to match_inventory table"""
        print("🏆 Starting 2023 Challenge Cup CSV import to match_inventory...")
        ...
        with open(csv_path, 'r', encoding='utf-8-sig') as csvfile:
            ...
            for row in reader:
                try:
                    ...
                    # Extract xG data (available in 2023)
                    ...
                    # Map match subtype name to subtype_id (2023 format - same as 2022)
                    ...
                    ''', (
                        ...
                        match_subtype_id,
                        match_subtype_name,
                        f"2023_challengecup_{match_id}.csv",  # filename reference
        ...
        print(f"\n🎉 2023 Challenge Cup CSV import complete!")
        print(f"   ✅ Successfully imported: {successful}")
        print(f"   ❌ Failed: {failed}")
        print(f"   🏆 Total 2023 Challenge Cup matches in inventory: {successful}")
    ...
    def _map_subtype_name_to_id(self, subtype_name):
        """Map 2023 Challenge Cup subtype name to subtype_id"""
        # Map 2023 Challenge Cup subtype names to our hex subtype_ids
        # 2023 format: Group stage + Semifinals + Final (same as 2022)
        mapping = {
    ...
    def _build_team_mapping(self, conn):
        ...
        # Add 2023-specific team mappings (continuing from 2022)
    ...
    def verify_import(self):
        ...
        print("🔍 Verifying 2023 Challenge Cup import...")
        
        conn = sqlite3.connect(self.db_path)
        
        # Count 2023 Challenge Cup matches by subtype
        counts = conn.execute('''
            ...
            WHERE mi.season_id = 2023 AND mi.match_type_name = 'Challenge Cup'
        ...
        print(f"   🏆 2023 Challenge Cup Summary:")
        ...
        # Show xG statistics for 2023 Challenge Cup
        xg_stats = conn.execute('''
            ...
            WHERE season_id = 2023 AND match_type_name = 'Challenge Cup'
        ''').fetchone()
        
        total, with_xg, avg_h, avg_a, max_h, max_a = xg_stats
        print(f"\n   📈 2023 Challenge Cup xG Statistics:")
...
if __name__ == "__main__":
    importer = Import2023ChallengeCupCSV()
