#!/usr/bin/env python3
"""
Import 2023 NWSL CSV to match_inventory
"""
...
class Import2023CSV:
    ...
    def import_csv_to_match_inventory(self, csv_path='data/excel_sheets/2023.csv'):
        """Import 2023 CSV data to match_inventory table"""
        print("📊 Starting 2023 CSV import to match_inventory...")
        ...
        with open(csv_path, 'r', encoding='utf-8-sig') as csvfile:
            ...
            for row in reader:
                try:
                    ...
                    # Extract week data (new for 2023)
                    ...
                    ''', (
                        ...
                        match_type_id,
                        match_type_name,
                        f"2023_csv_{match_id}.csv",  # filename reference
        ...
        print(f"\n🎉 2023 CSV import complete!")
        print(f"   ✅ Successfully imported: {successful}")
        print(f"   ❌ Failed: {failed}")
        print(f"   📊 Total 2023 matches in inventory: {successful}")
    ...
    def _build_team_mapping(self, conn):
        ...
        # Add 2023-specific mappings (continuing from 2022)
    ...
    def verify_import(self):
        ...
        print("🔍 Verifying 2023 import...")
        
        conn = sqlite3.connect(self.db_path)
        
        # Count 2023 matches by type
        counts = conn.execute('''
        ...
        total_2023 = sum(count for _, count in counts)
        
        print(f"   📊 2023 Season Summary:")
        for type_name, count in counts:
            print(f"      {type_name}: {count} matches")
        print(f"      Total: {total_2023} matches")
        ...
        for type_name, _ in counts:
            samples = conn.execute('''
                SELECT match_id, match_date, 
                       ...
                       xg_home, xg_away, wk
                FROM match_inventory 
                WHERE season_id = 2023 AND match_type_name = ?
                ORDER BY match_date
                LIMIT 3
            ''', (type_name,)).fetchall()
