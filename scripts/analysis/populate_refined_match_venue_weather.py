...
def load_match_timing_data(
    unprocessed_dir="/Users/thomasmcmillan/projects/nwsl_data/data/unprocessed",
):
...
def extract_venue_from_match_html(
    match_id, html_files_dir="/Users/thomasmcmillan/projects/nwsl_data/notebooks/match_html_files"
):
...
def populate_refined_match_venue_weather(
...
def main():
    ...
    populate_refined_match_venue_weather(db_path)
