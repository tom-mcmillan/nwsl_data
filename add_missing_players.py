...
MISSING_PLAYERS = [
    "Gabrielle Robinson", "Olivia Wade-Katoa", "Amanda Allen", "Luana", "Lysianne Proulx",
    "Maddie Pokorny", "Regan Steigleder", "Laurel Ivory", "McKenzie Weinert", "Mya Jones",
    "Maya Doms", "Emily Gray", "Landy Mertz", "Alex Kerr", "Lauren", "Cloé Lacasse",
    "Hillary Beall", "Shaelan Murison", "Cristina Roque", "Madison Ayson", "Jenna Butler",
    "Zoe Matthews", "Rosella Ayane", "Milly Clegg", "Ángela Barón", "Heather Hinz",
    "Mille Gejl", "Rikke Madsen", "Mimmi Larsson", "Jenna Walker", "Haley Bugeja",
    "Caitlin Cosme", "Civana Kuhlmann", "Zaneta Wyne", "Sami Feller", "Rylan Childers",
    "Sydney Collins", "Kaylie Collins", "Millie Farrow", "Marley Canales", "Clara Robbins",
    "Madelyn Desiano", "Lindsi Jennings", "Mackenzie Pluck", "Mia Gyau", "Chai Cortez",
    "Maliah Morris", "Tori Hansen", "Brittany Isenhour", "Brenna Lovera", "Riley Tanner",
    "Thais Reiss", "Sophie Jones", "Giovanna DeMarco", "Emily Alvarado", "Kelsey Hill",
    "Cheyenne Shorts", "Natalie Viggiano", "Jadyn Edwards", "Jordan Thompson", "Alyssa Walker",
    "Cyera Hintzen", "Sarah Clark", "Shea Connors", "Kayla Morrison", "Marleen Schimmer",
    "Sh'nia Gordon", "Nicole Baxter", "Jada Talley", "Chelsie Dawber", "Sydney Pulver",
    "Channing Foster", "Mikenna McManus", "Jacqueline Altschuld", "Sophie French",
    "Paulina Gramaglia", "Allyson Swaby", "Fūka Nagano", "Valérie Gauvin", "Taylor Hansen",
    "Kelly Livingstone", "Jade Moore", "Amber Marshall", "Yuka Momiki", "Jenna Hellstrom",
    "Autumn Smithers", "Zoe Redei", "Cassie Rohan", "Julia Bingham", "Hannah Davison",
    "Jaye Boissiere", "Aminata Diallo", "Mariah Lee", "Adrienne Jordan", "Meghan McCool",
    "Jessie Scarpa", "Dani Rhodes", "Aerial Chavarin", "Hailey Harbison", "Peyton Perea",
    "Bridgette Andrzejewski", "Melissa Lowder", "Savanah Uveges", "Miranda Nild",
    "Mikaela Howell", "Kim Hazlett"
]
