...
class AnalyticsContext:
    ...
    season_id: int
    opposition_strength: Optional[float] = None
...
class NWSLAnalyticsEngine:
    ...
    def calculate_advanced_metrics(self, entity_type: EntityType, entity_id: Any, 
                                 context: AnalyticsContext) -> Dict[str, Any]:
        """
    ...
    def _get_base_metrics(self, entity_type: EntityType, entity_id: Any, 
                         context: AnalyticsContext) -> Dict[str, Any]:
    ...
    def _get_player_base_metrics(self, conn: sqlite3.Connection, player_name: str, 
                                context: AnalyticsContext) -> Dict[str, Any]:
    ...
    def _get_team_base_metrics(self, conn: sqlite3.Connection, team_name: str, 
                              context: AnalyticsContext) -> Dict[str, Any]:
    ...
    def _get_match_base_metrics(self, conn: sqlite3.Connection, match_id: str, 
                               context: AnalyticsContext) -> Dict[str, Any]:
    ...
    def _calculate_nir(self, entity_type: EntityType, base_metrics: Dict[str, Any], 
    ...
    def _calculate_player_nir(self, metrics: Dict[str, Any], 
        ...
        ) * context_adjustment * 0.1      # Overall impact adjustment (scaled for interpretation)
    ...
    def _calculate_team_nir(self, metrics: Dict[str, Any], 
        ...
        # Final Team NIR
        final_nir = (
            attacking_impact * 0.4 +
            defensive_impact * 0.4 +
            progression_impact * 0.2
        ) * context_adjustment
    ...
    def _calculate_predictive_indicators(self, entity_type: EntityType, base_metrics: Dict[str, Any], 
                                       context: AnalyticsContext) -> Dict[str, float]:
        """
    ...
    def _get_historical_benchmarks(self, entity_type: EntityType, base_metrics: Dict[str, Any], 
                                  context: AnalyticsContext) -> Dict[str, float]:
        """
    ...
    def _generate_tactical_profile(self, entity_type: EntityType, base_metrics: Dict[str, Any], 
                                  context: AnalyticsContext) -> Dict[str, Any]:
