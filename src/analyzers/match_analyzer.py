    ...
    def get_team_performance_comparison(self, match_id: str) -> dict:
        ...
        try:
            with sqlite3.connect(self.db_path) as conn:
                ...
                return {"teams": stats.to_dict("records")}
        ...
        try:
            with sqlite3.connect(self.db_path) as conn:
                ...
                season_stats = pd.read_sql_query(
                    ...
                    """,
                    conn,
                    params=[season_id, match_data["team1_id"], match_data["team2_id"]],
                )
                ...
                return {
                    ...
                    "teams": {
                        match_data["team1_name"]: season_stats[
                            season_stats["team"] == match_data["team1_name"]
                        ].to_dict("records")[0]
                        if not season_stats.empty
                        else {},
                        match_data["team2_name"]: season_stats[
                            season_stats["team"] == match_data["team2_name"]
                        ].to_dict("records")[0]
                        if not season_stats.empty
                        else {},
                    },
