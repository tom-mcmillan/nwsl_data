    ...
    def get_top_scorers_in_season(self, season_id: int, limit: int = 10) -> dict:
        ...
        try:
            with sqlite3.connect(self.db_path) as conn:
                ...
                return {"season": season_id, "top_scorers": top_scorers.to_dict("records")}
    ...
    def get_top_assists_in_season(self, season_id: int, limit: int = 10) -> dict:
        ...
        try:
            with sqlite3.connect(self.db_path) as conn:
                ...
                return {"season": season_id, "top_assist_providers": top_assists.to_dict("records")}
        ...
        try:
            with sqlite3.connect(self.db_path) as conn:
                comparison_stats = pd.read_sql_query(
                    ...
                    """,
                    conn,
                    params=[player1_name, player2_name, season_id],
                )
                ...
                return {
                    "season": season_id,
                    "player_comparison": {player1_name: player1_stats, player2_name: player2_stats},
                }
    ...
    def get_position_leaders(self, position: str, season_id: int, stat: str = "goals") -> dict:
        ...
        try:
            with sqlite3.connect(self.db_path) as conn:
                ...
                position_leaders = pd.read_sql_query(
                    f"""
                    SELECT 
                        mp.player_name,
                        t.team_name_1 as team,
