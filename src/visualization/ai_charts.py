...
from .context_parser import DataType, ExtractedData, NWSLContextParser
...
class IntelligentVisualizationAgent:
    ...
    def _create_reasoning_agent(self) -> Agent | None:
    ...
    @function_tool
    def _strategy_selection_tool(self, data_summary: str, user_intent: str, data_type: str) -> dict[str, Any]:
        """
    ...
    @function_tool
    def _chart_styling_tool(self, chart_type: str, user_intent: str) -> dict[str, Any]:
        """
    ...
    @function_tool
    def _insight_generation_tool(self, data_summary: str, chart_type: str) -> dict[str, Any]:
        """
    ...
    async def create_intelligent_visualization(
        self, user_query: str, conversation_context: list[str]
    ) -> dict[str, Any]:
        """
        ...
        try:
            ...
            return {"error": str(e), "fallback_available": True, "user_query": user_query}
    ...
    def _parse_agent_response_to_strategy(
        self, agent_response: Any, extracted_data: ExtractedData
        ...
        try:
            ...
            fig.add_trace(
                go.Bar(
                    ...
                    x=goals,
                    orientation="h",
                    marker=dict(color=colors[: len(teams)], line=dict(color="rgba(0,0,0,0.3)", width=1)),
            ...
            return {
                ...
                "insights": [
                    ...
                    "Top 5 teams show competitive goal-scoring across the league",
