...
class SimpleChartGenerator:
            ...
            with sqlite3.connect(self.db_path) as conn:
                ...
                if df.empty:
                    ...
                    players_data = {
                        ...
                        "Savannah McCaskill": {"attacking": 0.0, "defensive": 2.39, "progression": 5.58},
                        "Shinomi Koyama": {"attacking": 0.08, "defensive": 2.86, "progression": 3.83},
    ...
    def _chart_team_goals(self) -> Dict[str, Any]:
        ...
        try:
            ...
            goals_per_match = [g/m for g, m in zip(goals, matches)]
            ...
            fig.add_trace(go.Bar(
                ...
                text=[f'{g} goals ({gpm:.1f}/match)' for g, gpm in zip(goals, goals_per_match)],
